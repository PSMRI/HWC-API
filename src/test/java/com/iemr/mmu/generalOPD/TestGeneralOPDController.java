...
public class TestGeneralOPDController {
	...
	private static GeneralOPDController updateControllerMock = spy(GeneralOPDController.class);
	private static GeneralOPDController fetchControllerMock = spy(GeneralOPDController.class);
	...
	public static void initializeParams() {
		...
		try {
			// Save API mocks
			// when(generalOPDServiceImplMock.saveNurseData(nurseJsnOBJPve)).thenReturn(new
			// Long(1L));
...
//		String response = createControllerMock.saveBenGenOPDNurseData(nurseObjPve);
		...
		assertEquals("", response.equals(
				"{\"data\":{\"response\":\"General OPD Nurse Entered Details stored successfully.\"},\"statusCode\":200,"
...
//		String response = createControllerMock.saveBenGenOPDNurseData(nurseObjNve);
	...
	public void saveGOPDDoctorDataPveTest() {
		...
		assertEquals("", response.equals(
				"{\"data\":{\"response\":\"General OPD doctor Entered Details stored successfully.\"},\"statusCode\":200,"
						+ "\"errorMessage\":\"Success\",\"status\":\"Success\"}"));
	}
	...
	public void saveGOPDDoctorDataNveTest() {
		...
		assertEquals("",
				response.equals(
						"{\"data\":{\"response\":\"Failed to store General OPD doctor Details.\"},\"statusCode\":200,"
								+ "\"errorMessage\":\"Success\",\"status\":\"Success\"}"));
	}
...
//	
	...
	public void getBenVisitDetailsFrmNurseGOPDPveTest() {
		...
		assertEquals("", response.equals(expectedRes));
	}
