package com.iemr.hwc.fhir.model.observation;
...
public class ObservationExt extends Observation {

    @Description(shortDefinition = "Contains providerServiceMapId ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.providerServiceMapId", isModifier = false, definedLocally = true)
    @Child(name = "providerServiceMapId")
    private StringType providerServiceMapId;

    @Description(shortDefinition = "Contains vanID ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.vanID", isModifier = false, definedLocally = true)
    @Child(name = "vanID")
    private StringType vanID;

    @Description(shortDefinition = "Contains parkingPlaceID ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.parkingPlaceID", isModifier = false, definedLocally = true)
    @Child(name = "parkingPlaceID")
    private StringType parkingPlaceID;

    @Description(shortDefinition = "Contains createdBy ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.createdBy", isModifier = false, definedLocally = true)
    @Child(name = "createdBy")
    private StringType createdBy;

    @Description(shortDefinition = "Contains modifiedBy ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.modifiedBy", isModifier = false, definedLocally = true)
    @Child(name = "modifiedBy")
    private StringType modifiedBy;

    @Description(shortDefinition = "Contains beneficiaryID ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.beneficiaryID", isModifier = false, definedLocally = true)
    @Child(name = "beneficiaryID")
    private StringType beneficiaryID;

    @Description(shortDefinition = "Contains benFlowID ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.benFlowID", isModifier = false, definedLocally = true)
    @Child(name = "benFlowID")
    private StringType benFlowID;

    @Description(shortDefinition = "Contains beneficiaryRegID ")
    @Extension(url = "http://hl7.org/fhir/StructureDefinition/Observation#Observation.beneficiaryRegID", isModifier = false, definedLocally = true)
