...
public class ImmunizationServiceImpl implements ImmunizationService{
    ...
    @Override
    public ImmunizationExt addOrUpdateImmunization(HttpServletRequest theRequest, ImmunizationExt immunizationExt) throws Exception{
        ...
        CovidVaccineStatusDTO covidVaccineStatusDTO = mapper.immunizationResourceToCovidVaccineStatusDTO(immunizationExt, mandatoryFieldsDTO);
        ...
        if (response.getStatusCodeValue() == 200 && response.hasBody()
            ...
            logger.error("Encountered error while trying to save/update covid vaccine details.Error - " + responseJson.get("errorMessage"));
            throw new InternalErrorException("Encountered error while trying to save/update covid vaccine details.Error - " + responseJson.get("errorMessage"));
        }
