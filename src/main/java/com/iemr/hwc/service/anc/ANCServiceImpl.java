...
import com.iemr.hwc.data.anc.ComplicationDuringPregnancyHRP;
import com.iemr.hwc.data.anc.DeliveryComplicationHRP;
import com.iemr.hwc.data.anc.HrpStatusAndReasonsRequestModel;
import com.iemr.hwc.data.anc.PastObstetricHostoryHRP;
	...
	public Long saveANCDoctorData(JsonObject requestOBJ, String Authorization) throws Exception {
		...
		if (requestOBJ != null) {
			...
			prescriptionID = commonNurseServiceImpl.savePrescriptionDetailsAndGetPrescriptionID(
					...
					prescription_counsellingProvided, null);
			...
			if (i < 1) {
				...
				if (benVisitID != null && benVisitID > 0 && benVisitCode != null && benVisitCode > 0) {
					if (visitDetailsOBJ.has("chiefComplaints")
						...
						chiefComplaintsSuccessFlag = commonNurseServiceImpl
								.saveBenChiefComplaints(benChiefComplaintList);
					}
